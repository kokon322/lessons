...
// let inpyt1 = document.createElement('input');
// let inpyt2 = document.createElement('input');
// let inpyt3 = document.createElement('input');
...
// inpyt1.type = 'checkbox';
// inpyt2.type = 'checkbox';
// inpyt3.type = 'checkbox';

// label1.innerText = 'со статусом false';
// label2.innerText = 'старше 29 лет ';
// label3.innerText = 'город киев';

// divText.appendChild(inpyt1);
// divText.appendChild(label1);
// divText.appendChild(inpyt2);
// divText.appendChild(label2);
// divText.appendChild(inpyt3);
// divText.appendChild(label3);
...
// button.onclick = ()=>{
//     if(inpyt1.checked){
//         masStatus = usersWithAddress.filter((value)=>{
//             if(value.status){
//                 return false;
//             }return true;
//         });
//     }console.log(masStatus);
//     if(inpyt2.checked){
//         masAge = usersWithAddress.filter((value)=>{
//             if(value.age >= 29){
//                 return true;
//             }return false;
//         });
//     }console.log(masAge);
//     if(inpyt3.checked){
//         masCity = usersWithAddress.filter((value)=>{
//             if(value.address.city === 'Kyiv'){return true;
//             }return false;
//         });
//     }console.log(masCity);
//     };
